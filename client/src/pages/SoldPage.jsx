    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <form onSubmit={handleSearch} className="glass-panel p-5 rounded-2xl border border-slate-200">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 font-extrabold text-sm hover:from-amber-400 hover:to-amber-500 transition-all flex items-center space-x-2 shadow-lg shadow-amber-500/20"
          >
