        ...
        <button
          ...
          className={`absolute top-3 right-3 p-2 rounded-full backdrop-blur-md border transition-all ${
            saved
              ...
              : 'bg-slate-900/80 text-slate-300 border-slate-700 hover:text-rose-400 hover:scale-110'
          }`}
          title="Save Property"
        >
      ...
      <div className="p-5 space-y-3">
        <div>
          ...
          <Link to={`/properties/${property._id}`}>
            <h3 className="text-base font-bold text-white group-hover:text-amber-400 transition-colors line-clamp-1 mt-0.5">
              {property.title}
            </h3>
          </Link>
          <p className="text-xs text-slate-400 flex items-center space-x-1 mt-1 line-clamp-1">
        ...
        {/* Property Specs */}
        <div className="grid grid-cols-4 gap-2 py-2.5 px-3 rounded-xl bg-slate-900/60 border border-slate-800/80 text-slate-300 text-xs">
